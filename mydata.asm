; This file contains the data used to hide the enc_flag
...
section .data
  ...
  bytes1 dq 0x00014c4c5e, 0x005130720c, 0x003e87df91, 0x00340ccb70, 0x00676fa321, \
  ...
  bytes2 dq 0x0002f21618, 0x00577d3f68, 0x000c838fda, 0x0068e5cdc4, 0x006314b34d, \
  ...
  bytes3 dq 0x0053d9c12d, 0x007e4f6f47, 0x0056084aad, 0x0053ce10aa, 0x00349ef85d, \
  ...
  bytes4 dq 0x0051095f4d, 0x000bd6fed3, 0x0021d06bec, 0x0068a2be66, 0x0065b4db28, \
...
enc_flag dq 0x00a8f102ca, 0x00e2b9dd62, 0x003ed39153, 0x0137df46d7, 0x0163cf8a22, \
            0x0130e20046, 0x0059c5c460, 0x00e4b06973, 0x00b6f2b75a, 0x0073c8b667, \
            0x00c89c6eac, 0x0112b68357, 0x01060a1a6e, 0x00f81b68cd, 0x00d9941c8e, \
            0x0111dd04ec, 0x0122e71883, 0x014cbd3537, 0x003c2b5114, 0x00b9830742, \
            0x01196222de, 0x00a85750fc, 0x0041cb19ff, 0x005eee9322, 0x005697354b, \
            0x00a7a5c056, 0x00688bad0a, 0x0170328748, 0x00ba9e93e3, 0x0138b04da1
  

section .text

; data item number is in rdi
; enc_flag data returned in rax
Enc_flag:
    mov rax, [enc_flag + rdi*8]
    ret

val_1:
    mov rax, [bytes1 + rdi*8]
    ret

val_2:
    mov rax, [bytes2 + rdi*8]
    ret

val_3:
    mov rax, [bytes3 + rdi*8]
    ret

val_4:
    mov rax, [bytes4 + rdi*8]
    ret
